"""One-shot DeepSeek-only smoke of the two authorized fixtures. Never imports workflows."""
import argparse
import base64
import hashlib
import json
...
def main():
    ...
    output=ROOT/'evaluation/reports/live_deepseek_smoke'
    ...
    result={'started_at':datetime.now(timezone.utc).isoformat(),'provider':'deepseek','model':'deepseek-flash',
        'maximum_requests':2,'sdk_retries':0,'validation_attempts':1,'requests_attempted':0,
    ...
    try:
        for name in ['01_safe.jpg','02_obvious_hazard.jpg']:
